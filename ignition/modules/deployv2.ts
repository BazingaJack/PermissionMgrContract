...
const DeployModule = buildModule("DeployModule", (m) => {
  ...
  const _maxValidators = m.getParameter("_maxValidators", MAX_VALIDATORS);

  const permissionManager = m.contract("PermissionManagerV2", [_roundBlocks, _roundTimeout, _zeroPointOneEther, _maxValidators], {
